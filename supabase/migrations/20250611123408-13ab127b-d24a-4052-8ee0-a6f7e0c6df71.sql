...
-- Ajouter la colonne avatar_url à la table user_profiles
...
-- Créer une politique pour permettre aux utilisateurs authentifiés de télécharger leurs avatars
...
-- Créer une politique pour permettre à tous de voir les avatars (publique)
