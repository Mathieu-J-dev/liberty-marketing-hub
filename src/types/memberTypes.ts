...
export type ContentItem = {
  ...
  imageUrl: string;
  url: string;
  downloadUrl?: string;  // URL pour téléchargement direct (optionnel)
  type: 'pdf' | 'video' | 'course';
  date: string;
  premium: boolean;
  affiliateLink?: string; // Lien d'affiliation optionnel
};
...
export const memberContent: ContentItem[] = [
  {
    ...
    url: '#pdf-guide',
    downloadUrl: 'https://example.com/guide-affiliation-2025.pdf', // Ajoutez ici le lien vers votre PDF réel
    type: 'pdf',
    date: '15 Mai 2025',
    premium: true
  },
  {
    ...
    date: '28 Mars 2025',
    premium: true,
    affiliateLink: 'https://votreaffilie.com/ref=12345'
  },
  {
    id: '3',
    ...
    url: 'https://cours.affi-liberty.com/seo-masterclass',
    type: 'course',
    date: '10 Avril 2025',
    premium: true,
    affiliateLink: 'https://votreaffilie.com/ref=seo2025'
  },
  {
    id: '4',
    ...
    url: 'https://webinaire.affi-liberty.com/conversion',
    type: 'video',
    date: '22 Juin 2025',
    premium: true
  },
  {
    ...
    url: '#pdf-secrets',
    downloadUrl: 'https://example.com/secrets-super-affilies.pdf', // Ajoutez ici le lien vers votre PDF réel
    type: 'pdf',
    date: '5 Février 2025',
    premium: true,
    affiliateLink: 'https://votreaffilie.com/ref=superaffilie'
  }
];
